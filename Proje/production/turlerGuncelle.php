        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-8 col-sm-8  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Film Türü Bilgileri <br><small>Film Türü verileri anlık olarak veritabanından güncellenmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
					<div class="x_content">
					...
					if($_POST['updatetur']){ 
						...
						if(!$yeniturAdi){
							...
							if($updateturInfo){
								...
								echo "Film Türü bilgileri güncellendi!";
								header("Refresh:1"); 
						...
						<form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="item form-group">
								<div class="col-md-6 col-sm-6 offset-md-3">	
									...
									<input type="submit" name="updatetur" class="btn btn-success" value="Güncelle"> 
								</div>
							</div>
