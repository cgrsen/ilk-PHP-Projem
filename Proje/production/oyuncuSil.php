...
$delete= mysqli_query($baglan, "DELETE FROM oyuncular WHERE oyuncuID=$oyuncuID"); 
if($delete){ 
?>
...
<html>
    ...
    $(function() {
      ...
      var interval = setInterval(function() {
        ...
        if (current_progress >= 100)
          ...
          <?php
              header("Refresh: 2; url=oyuncular.php");
          ?>
        }, 200);
      });
    </script>
  ...
  <body style="background-color: #f2f2f2;">
    <div class="card" style="margin-top: 10%; margin-left: 25%; width: 50%; box-shadow: 0px 0px 110px -25px rgba(0,0,0, 0.5);">
      <div class="card-body">
        <p class="card-text">Seçili oyuncu bilgileri silindi. Oyuncular sayfasına yönlendiriliyorsunuz.</p>
        <div class="progress">
...
<html>
  ...
  <body style="background-color: #f2f2f2;">
    <div class="card" style="margin-top: 10%; margin-left: 25%; width: 50%; box-shadow: 0px 0px 110px -25px rgba(0,0,0, 0.5);">
      <div class="card-body">
        <p class="card-text">Oyuncu bilgileri silinirken bir hata oluştu.</p>
        <div class="progress">
            <div id="dynamic" class="progress-bar progress-bar-success progress-bar active" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
                <!--<span id="current-progress"></span>-->
            </div>
