        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Film Türleri Listesi <br><small>Veriler güncellenmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
					  ...
					  ?>
						...
						<tr>
						  ...
						  <td style="<?php echo $tableStyle; ?>">
							...
							<a href='turlerGuncelle.php?turID=<?php echo $turID; ?>&user_id=<?php echo $userID; ?>' style='width:100px; font-size:12px;' class='btn btn-primary btn-xs'><i class='fa fa-search'></i> Düzenle </a>
