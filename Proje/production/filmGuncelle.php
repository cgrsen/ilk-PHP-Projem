        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-8 col-sm-8  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Film Bilgileri <br><small>Film verileri anlık olarak veritabanından çekilmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
					<div class="x_content">
					...
					$filmInfo=mysqli_query($baglan,"SELECT * FROM filmler WHERE filmID=$filmID");
					$readfilmInfo = mysqli_fetch_array($filmInfo);
					...
					if($_POST['updatefilm']){ 
						...
						if(!$yenifilmAdi || !$yenifilmTur || !$yeniIMDBpuan || !$yeniTarih ){
							...
							$updatefilmInfo = mysqli_query($baglan, "UPDATE filmler SET Ad='$yenifilmAdi',Tur='$yenifilmTur', IMDB_Puan='$yeniIMDBpuan', Tarih='$yeniTarih' WHERE filmID=$filmID");
							
							if($updatefilmInfo){
								
								echo "Film bilgileri güncellendi!";
								header("Refresh:1"); 
						...
						<form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="item form-group">
								<div class="col-md-6 col-sm-6 offset-md-3">	
									...
									<input type="submit" name="updatefilm" class="btn btn-success" value="Güncelle"> 
								</div>
							</div>
